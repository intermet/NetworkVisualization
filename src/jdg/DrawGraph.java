...
public class DrawGraph extends PApplet {
    ...
    public static int sizeX=1000; // horizontal size of the canvas (pizels)
    public static int sizeY=1000; // vertical size of the canvas (pixels)
    Point_2 a,b; // range of the window (left bottom and right top corners)
	  ...
	  public void keyPressed(){
		  switch(key) {
		  	...
		  	case('c'):this.layoutFR91.computeLayout(); this.inputGraph = this.layoutFR91.graph; break;
		  	case('f'):this.layoutFastFR91.computeLayout(); this.inputGraph = this.layoutFastFR91.graph; break;
